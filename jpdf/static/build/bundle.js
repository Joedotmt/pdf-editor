    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file_1, 215, 4, 6139);
    			...
    			add_location(div1, file_1, 218, 4, 6257);
    			...
    			add_location(div2, file_1, 221, 4, 6374);
    			...
    			add_location(div3, file_1, 224, 4, 6497);
    			...
    			add_location(div8, file_1, 207, 2, 5903);
    			...
    			add_location(img, file_1, 248, 4, 7473);
    			...
    			add_location(div9, file_1, 244, 2, 7300);
    			attr_dev(canvas_1, "class", "w-full h-full");
    			add_location(canvas_1, file_1, 250, 2, 7552);
    			...
    			add_location(div10, file_1, 202, 0, 5744);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	function handlePanMove(event) {
    		...
    		if (operation === "scale") {
    			if (direction === "left") {
    				...
    				if (ratio !== null) {
    					$$invalidate(8, [dw, dh] = calculateDimensionWithRatio(dw, -Infinity), dw, $$invalidate(9, dh));
    				}
    				...
    				if (ratio !== null) {
    					$$invalidate(8, [dw, dh] = calculateDimensionWithRatio(dw, dh), dw, $$invalidate(9, dh));
    				}
    				...
    				if (ratio !== null) {
    					$$invalidate(8, [dw, dh] = calculateDimensionWithRatio(-Infinity, dh), dw, $$invalidate(9, dh));
    				}
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 272, 4, 7831);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$6, 359, 6, 11217);
    			attr_dev(div, "class", "w-full flex-grow flex justify-center items-center");
    			add_location(div, file$6, 358, 4, 11147);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$6, 229, 8, 6202);
    			...
    			add_location(button, file$6, 257, 4, 7283);
    			...
    			add_location(img4, file$6, 266, 6, 7685);
    			attr_dev(a, "href", "https://github.com/ShizukuIchi/pdf-editor");
    			add_location(a, file$6, 265, 4, 7626);
