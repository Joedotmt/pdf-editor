<script>
  ...
  _lineHeight = Math.max(1, initialLineHeight + deltaY / 1000);
}
...
<div
  ...
  <div class="relative">
    ...
    <div
      ...
      style="font-size: {_size}px; font-family: '{_fontFamily}', serif; line-height: {_lineHeight}; -webkit-user-select: text; white-space: nowrap;">
    </div>
  </div>
</div>
